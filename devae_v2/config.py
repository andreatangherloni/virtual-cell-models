...
class ModelConfig:
    ...
    # Disentangled Gating (New)
    use_gated_delta: bool = True      # Enable separate Gate vs Magnitude prediction
    gate_temp: float = 1.0            # Temperature for gate sigmoid refinement
...
class TrainConfig:
    ...
    lambda_nce: float = 0.0       # Contrastive Loss (PDS)
    lambda_smooth: float = 0.0
    lambda_mmd: float = 0.0
    lambda_gate_sparsity: float = 0.0  # New: Sparsity for the gate (DES)
