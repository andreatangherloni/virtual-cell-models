...
class PerturbationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Context encoding
        batch_id = self.batch_to_id.get(str(obs.get(self.cfg.col_batch, 'unknown')), 0)
        celltype_id = self.celltype_to_id.get(str(obs.get(self.cfg.col_celltype, 'unknown')), 0)
    ...
    @staticmethod
    def save_mappings(gene_to_idx: Dict, batch_to_id: Dict, celltype_to_id: Dict, outdir: str):
    ...
    def save_mappings(self, outdir: str):
        ...
        self.save_mappings(self.gene_to_idx, self.batch_to_id, self.celltype_to_id, outdir)
